<script>
  ...
  function getElements() {
    axios.get("http://localhost:8080/elements/all").then((response) => {
...
<div class="mb-5">
  <h1 class="mt-3">Liste aller Elemente</h1>

  <p>um zu bearbeiten, nach Simple oder Komplex filtern</p>
            ...
            ><div class="abstand">
              <a href={"#/elements"}
                ><button
                  ...
                  disabled
                  type="button"><i class="fas fa-edit" /></button
                ></a
              >
            </div></td
          >
