<script>
  ...
  function getElements() {
    axios.get("http://localhost:8080/complex/all").then((response) => {
...
<div class="mb-5">
  <h1 class="mt-3">Liste aller Complex</h1>
        ...
        {#each elements as element}
          <tr>
            ...
            <td><div class="abstand">
              <a href={"#/complex/edit/"+element.id}
                ><button class="btn btn-warning" type="button"><i class="fas fa-edit" /></button></a
              >
            </div></td>
          </tr>
        {/each}
